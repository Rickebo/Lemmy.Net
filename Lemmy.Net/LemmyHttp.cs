...
public class LemmyHttp : LemmyHttpClient
{
    ...
    /// <summary>
    /// Logs in to the Lemmy instance and sets the AuthToken property. If successful, subsequent authenticable requests
    /// will be updated to contain the acquired auth token automatically.
    /// </summary>
    /// <param name="usernameOrEmail">
    /// Username or email to identify the user to log in as.
    /// </param>
    /// <param name="password">
    /// Password to authenticate the user with.
    /// </param>
    /// <param name="totp2faToken">
    /// If the user has 2FA enabled, this is the token generated by the authenticator app.
    /// </param>
    ...
    /// <summary>
    /// Enumerates all posts on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request. If null, the default request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all posts on the Lemmy instance.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all comments on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what comments to enumerate. If null, the default request will
    /// be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all comments on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all mod log entries on the Lemmy instance.
    /// </summary>
    /// <param name="selector">
    /// Selector to select the type of mod log entries to enumerate. If null, all mod log entries will be enumerated.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <typeparam name="T">
    /// Type of mod log entries to enumerate, which the selector returns.
    /// </typeparam>
    /// <returns>
    /// An async enumerable of all mod log entries on the Lemmy instance matching the specified selector.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all mod log entries on the Lemmy instance matching a specified request.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what mod log entries to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="selector">
    /// Selector to select the type of mod log entries to enumerate.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    ...
    /// </typeparam>
    /// <returns>
    /// An async enumerable of all mod log entries on the Lemmy instance matching the specified request and selector.
    /// </returns>
    public async IAsyncEnumerable<T> GetAllModlog<T>(
        GetModlog? request,
        Func<GetModlogResponse, IEnumerable<T>> selector,
    ...
    /// <summary>
    /// Enumerates all person details on the Lemmy instance.
    /// </summary>
    /// <param name="selector">
    /// Selector to select the type of person details to enumerate. 
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <typeparam name="T">
    /// Type of person details to enumerate, which the selector returns.
    /// </typeparam>
    /// <returns>
    /// An async enumerable of all person details on the Lemmy instance matching the specified selector.
    /// </returns>
    ...
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what person details to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="selector">
    /// Selector to select the type of person details to enumerate.
    ...
    /// </typeparam>
    /// <returns>
    /// An async enumerable of all person details on the Lemmy instance matching the specified request and selector.
    /// </returns>
    public async IAsyncEnumerable<T> GetAllPersonDetails<T>(
    ...
    /// <summary>
    /// Enumerates all person mentions on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what person mentions to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all person mentions on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all private messages on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what private messages to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all private messages on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all replies on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what replies to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all replies on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all comment reports on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what comment reports to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all comment reports on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all communities on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what communities to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    ...
    /// <summary>
    /// Enumerates all post reports on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what post reports to enumerate. If null, the default
    /// request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all post reports on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all private message reports on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what private message reports to enumerate. If null, the
    ...
    /// </param>
    /// <returns>
    /// An async enumerable of all private message reports on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates all registration applications on the Lemmy instance.
    /// </summary>
    /// <param name="request">
    /// Request to use for the initial request to specify what registration applications to enumerate. If null, the
    /// default request will be used.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <returns>
    /// An async enumerable of all registration applications on the Lemmy instance matching the specified request.
    /// </returns>
    ...
    /// <summary>
    /// Enumerates through paginated results of type <typeparamref name="TEntry"/> from pages of type
    /// <typeparamref name="TPage"/>.
    /// </summary>
    /// <param name="seed">
    /// The initial request to use to start the enumeration. Is updated by incrementing its
    /// <see cref="IPaginatedResult.Page"/> property to enumerate following pages.
    /// </param>
    /// <param name="pageReader">
    /// A function that takes a request and returns a page of type <typeparamref name="TPage"/>. If the request
    /// returns null, the enumeration will stop.
    /// </param>
    /// <param name="entryReader">
    /// A function that takes a page and returns an enumerable of entries of type <typeparamref name="TEntry"/>.
    /// </param>
    /// <param name="cancellationToken">
    /// Cancellation token to cancel the enumeration.
    /// </param>
    /// <typeparam name="TRequest">
    /// The type of the request to use to enumerate the pages.
    /// </typeparam>
    /// <typeparam name="TPage">
    /// The type of the page returned as a result of submitting the request.
    /// </typeparam>
    /// <typeparam name="TEntry">
    /// The type of the entries to enumerate.
    /// </typeparam>
    /// <returns>
    /// An async enumerable of all entries of type <typeparamref name="TEntry"/> from all pages enumerated.
    /// </returns>
